...
let dirY = true; // Initialize dirY as a property of Obj
let dirX = true;
let Score1 = 0;
let Score2 = 0;
...
function drawPads(Pad1YPos, Pad2YPos) {
	...
	let Pad2 = new Obj(docWidth - ((docWidth * 2) / 100), Pad2YPos, 25, 100, 'blue');
	Pad1.drawPad();
	Pad2.drawPad();
}
...
function canvasSetup() {
	docHeight = window.innerHeight - 10;
	docWidth = window.innerWidth - 10;
	canvas.height = docHeight;
	canvas.width = docWidth;
	Pad2YPos = (docHeight / 2) - 50;
	Pad1YPos = (docHeight / 2) - 50;
	drawPads(Pad1YPos, Pad2YPos)
