    ...
    async getHtml() {
		...
		<div class="container">
			<div class="row gy-3 gx-3" ">
                ...
                <div class="col-12 " style=" background-color: #282828; border-radius: 10px;">
                    <div style="color: white;display: flex;padding-top: 20px;padding-bottom: 20px;padding-left: 20px;">
						<div style="margin-left: 30px;">
							<div>
								<div style="display: flex;flex-direction: row;">
									<img id="profile-pic" src="./static/assets/images/icon.svg" style="width: 87px;">
								</div>
							</div>
						</div>
			...
			<div class="row row-cols-3 g-2   justify-content-start align-items-start" style="background-color: ;" >
                ...
                <div class="col-9" style="margin-top: 20px; background-color: ;">
                    <div class="col-12  gy-" style="background-color: #282828;border-radius: 10px;">
                        <div class="row row-cols-2">
                            <!-- <div class="col-3" style="background-color: ;">
                            </div> -->
                            <div class="col-12" style="display: flex;justify-content: start; background-color: #282828;color: white;padding-top: 20px;padding-bottom: 20px;padding-left: 20px;">
                                <div >
                ...
                <div class="col-3 gy2 gx-3 overflow-scroll" style="margin-top: 20px; height: 445px;border-radius: 10px; background-color: #282828;color: white;">
                    <div style="display: flex;justify-content: center;padding-top: 10px;">
                        <h4>Online friends</h4>
                    </div>
                    <div>
                        <ul class="list-group">
                            <li class="list-group-item" style="display: flex;justify-content: center; background-color: #494949;color: white;"><img src="./static/assets/images/icon.svg" style="width: 15px;">username</li>
                            <li class="list-group-item" style="display: flex;justify-content: center; background-color: #282828;color: white;"><img src="./static/assets/images/icon.svg" style="width: 15px;">username</li>
                            <li class="list-group-item" style="display: flex;justify-content: center; background-color: #494949;color: white;"><img src="./static/assets/images/icon.svg" style="width: 15px;">username</li>
                            <li class="list-group-item" style="display: flex;justify-content: center; background-color: #282828;color: white;"><img src="./static/assets/images/icon.svg" style="width: 15px;">username</li>
                            <li class="list-group-item" style="display: flex;justify-content: center; background-color: #494949;color: white;"><img src="./static/assets/images/icon.svg" style="width: 15px;">username</li>
                            <li class="list-group-item" style="display: flex;justify-content: center; background-color: #282828;color: white;"><img src="./static/assets/images/icon.svg" style="width: 15px;">username</li>
